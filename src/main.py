...
def main():
    if len(sys.argv) > 1 and sys.argv[1] == "--help":
        ...
        print(f"  OPENAI_WIRE_API - Upstream API: responses or chat (default: responses)")
        print(f"  OPENAI_REASONING_EFFORT - Responses reasoning effort (default: xhigh)")
        print("")
        print("Model mapping:")
    ...
    print(f"   OpenAI Wire API: {config.openai_wire_api}")
    print(f"   OpenAI Reasoning Effort: {config.openai_reasoning_effort}")
